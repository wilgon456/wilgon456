...
꾸준히 만들고, 실제로 돌아가게 다듬는 사람입니다.
AI 도구, 자동화, 트레이딩 시스템처럼 아이디어가 현실에서 작동하는 순간을 좋아합니다.
...
### ai-stock-bot-2.0
국내 주식 시장을 대상으로 한 인트라데이 트레이딩 봇입니다.
리서치, 진입 판단, 메타 레이블, 실행, 리스크 제어를 분리해 방어적인 운영 구조를 지향합니다.
